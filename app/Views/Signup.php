...
<html lang="en">
    ...
    <body>
		...
		<div class="signup-form">
			...
			<h2>Register</h2>
			<p class="hint-text">Create your account instantly.</p>
			...
			<form action="<?php echo base_url(); ?>/Signup" method="post">
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="form-group">
							<?php echo form_input(['name'=>'email','class'=>'form-control','value'=>set_value('emailid'),'placeholder'=>'Enter your Email id']);?>
						</div>
